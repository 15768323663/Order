...
public class DualPivotQuickAlgoFrame extends JFrame{

    private int canvasWidth;
    private int canvasHeight;

    public DualPivotQuickAlgoFrame(String title, int canvasWidth, int canvasHeight){
    ...
    public DualPivotQuickAlgoFrame(String title){
    ...
    public void render(QuickSortDualPivotData data){
        this.data = data;
        repaint();
    }
